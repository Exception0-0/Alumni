...
interface RegistrationRepository {
    ...
    suspend fun submit(form: RegistrationForm): Either<Failure, Unit>
    suspend fun accept(status: RegistrationForm): Either<Failure, Unit>
    suspend fun reject(status: RegistrationForm): Either<Failure, Unit>
}