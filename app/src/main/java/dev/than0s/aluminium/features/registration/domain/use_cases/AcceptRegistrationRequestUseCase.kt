...
class AcceptRegistrationRequestUseCase @Inject constructor(private val repository: RegistrationRepository) {
    suspend operator fun invoke(registrationRequestId: String): SimpleResource {
        return repository.acceptRegistrationRequest(registrationRequestId)
    }
}